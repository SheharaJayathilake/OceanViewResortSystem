...
public class GuestDAOTest {
    ...
    public void setUp() {
        ...
        // Create a dynamic 10-digit string for contact to prevent returning old DB
        // records
        String dynamicContact = "07" + String.valueOf(System.currentTimeMillis() % 100000000L);
        testGuest.setContactNumber(dynamicContact);
    ...
    public void testFindGuestByContact() throws DAOException {
        ...
        Optional<Guest> foundGuest = guestDAO.findByContact(createdGuest.getContactNumber());
